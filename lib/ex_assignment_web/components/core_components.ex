defmodule ExAssignmentWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ExAssignmentWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ExAssignmentWeb.Gettext, "errors", msg, opts)
    # end
